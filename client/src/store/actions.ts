...
export const homeCardDescription =
...
export const SearchExtendedDescription =
  (searchChosenMovie: string) => async (dispatch: Dispatch) => {
    try {
...
export const ModalDetailsDescription =
...
export const movieChosenFromSearchComp =
